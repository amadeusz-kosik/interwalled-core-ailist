...
public class ListBuilding {
    ...
    public void benchmarkBulkLoad(final Blackhole blackhole) {
        AIListBuilder<String> aiListBuilder = new AIListBuilder<>(AIListConfiguration.DEFAULT, dataSources.get(dataSource));
    ...
    public void benchmarkIterativeLoad(final Blackhole blackhole) {
        AIListBuilder<String> aiListBuilder = new AIListBuilder<>(AIListConfiguration.DEFAULT);
